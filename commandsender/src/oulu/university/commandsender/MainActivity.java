...
public class MainActivity extends Activity implements View.OnClickListener, ICallback {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        SendBtn = (Button)findViewById(R.id.dialog_confirm); SendBtn.setOnClickListener(this);
        LinphoneBtn = (Button)findViewById(R.id.LinphoneBtn); LinphoneBtn.setOnClickListener(this);
        ...
        LeftBtn = (Button)findViewById(R.id.command_left_btn);LeftBtn.setOnClickListener(this);
        RightBtn = (Button)findViewById(R.id.command_right_btn);RightBtn.setOnClickListener(this);
        StopBtn = (Button)findViewById(R.id.command_stop_btn);StopBtn.setOnClickListener(this);
        ForwordBtn = (Button)findViewById(R.id.command_forward_btn);ForwordBtn.setOnClickListener(this);
