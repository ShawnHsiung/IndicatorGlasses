 ...
 */
public class LinphoneMiniManager implements LinphoneCoreListener,ICallBackSendMessage {
...
//            chat_room.sendMessage("Hello world");
    ...
    public void registrationState(LinphoneCore lc, LinphoneProxyConfig cfg,
        ...
        LinphoneChatRoom chat_room = mLinphoneCore.getOrCreateChatRoom("sip:indicator_glasses@sip.linphone.org"); //lc is object of LinphoneCore
    ...
    @Override
    public void callBackLinphoneSendMessage(String linphoneMessageValue) {
        LinphoneChatRoom chat_room = mLinphoneCore.getOrCreateChatRoom("sip:indicator_glasses@sip.linphone.org"); //lc is object of LinphoneCore
        chat_room.sendMessage(linphoneMessageValue);
    }
}
